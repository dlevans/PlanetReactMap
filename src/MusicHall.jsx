...
const GRAND_BALLROOM_ID = 'music' 

export default function MusicHall({ checked, rooms, onSelectBooth, selectedKey }) {
  ...
  return (
    <div className="MusicHall-wrap">
      <ZoomPanViewport>
        <div className="hall-image-wrap">
          <PuzzleImage
            src="/images/music_hall/music_hall.png"
            alt="Music Hall"
            room={room}
